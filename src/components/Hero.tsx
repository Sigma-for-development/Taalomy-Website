            ...
            <div className="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <div className="relative w-full aspect-[4/5] rounded-[2.5rem] overflow-hidden border-8 border-surface shadow-2xl bg-surface/50 backdrop-blur-sm flex items-center justify-center group">
                        ...
                        <img src="/taalomy_app_showcase.png" alt="Taalomy Academic Platform App Interface" className="w-full h-full object-cover transform transition-transform duration-700 hover:scale-105" />
                    </div>
                </motion.div>
            </div>
        </section>
