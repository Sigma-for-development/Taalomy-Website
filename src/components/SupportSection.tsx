        ...
        <section className="py-20 bg-background" id="support">
            <div className="container mx-auto px-6">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="bg-gradient-to-br from-surface to-background border border-text-primary/10 rounded-[2.5rem] p-8 md:p-16 text-center relative overflow-hidden"
                >
                    <div className="relative z-10 max-w-3xl mx-auto">
                        <div className="w-16 h-16 bg-primary/20 rounded-2xl flex items-center justify-center text-primary mx-auto mb-8">
                            <Headset size={32} />
                        </div>
                        <h2 className="text-3xl md:text-5xl font-bold text-text-primary mb-6">{t('support_section.title')}</h2>
